 ...
 * <p>
 * Items can be added using {@link #addItem(AppNavItem)} and hierarchy can be created by
 * adding {@link AppNavItem} instances to other {@link AppNavItem} instances.
 */
...
public class AppNav extends Component implements HasSize, HasStyle {
	 ...
	 * <p>
	 * This can help the end user to distinguish groups of navigation items. The label is
	 * also available for screen reader users.
	...
	/**
	 * Check if the end user is allowed to collapse/hide and expand/show the navigation
	 * items.
	 * <p>
